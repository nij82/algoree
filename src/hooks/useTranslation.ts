...
const ko: TranslationKeys = {
    ...
    hero_desc: "엄선된 심우주 좌표의 시퀀스입니다.",
    hero_desc_highlight: "100개의 심우주 좌표",
    hero_btn: "축 재구성",

    modal_protocol: "동기화된 프로토콜",
    modal_deep_dive: "심층 탐사 시퀀스",
    modal_beyond_bubble: "버블 너머의 세계",
    modal_beyond_desc: "낮은 노출도와 높은 참여율을 가진 인접 좌표가 탐지되었습니다.",
    modal_beyond_highlight: "낮은 노출도 / 높은 참여율",
    modal_loading: "메타 좌표 해독 중...",
    ...
    access_desc: "디스커버리 엔진은 보이지 않는 세계를 매핑하기 위해 프로필과의 보안 연결이 필요합니다.",
    access_btn: "프로필 계정 연결",
    scanning_title: "스캐닝 중",
    scanning_accent: "심우주",
    scanning_desc: "버블 너머의 좌표를 검증 중입니다...",
